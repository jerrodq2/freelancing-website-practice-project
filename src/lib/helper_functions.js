...
// Used to find the column for a specific constraint in error messages. There are two possible types of constraint messages given, I act accordingly for each below
