...
module.exports = async(opts = {}) => {
	...
	// by creating a client, freelancer, we save them several other records having to be created in the various mixins for the client_review, this is especially helpful in the multi mixin
