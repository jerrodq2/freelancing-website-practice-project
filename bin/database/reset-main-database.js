...
//The below code assumes that the main database doesn't currently exists. Therefore, if we start by connecting to the default postgres empty database so we can make queries without erroring out
...
knex.raw(`select pg_terminate_backend(pid)
