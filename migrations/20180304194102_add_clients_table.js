...
// creates the clients table, these are users that post jobs for freelancers. They can also send use the 'invitations' table to invite a freelancer to a specific job
